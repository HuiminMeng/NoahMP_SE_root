...
!=== read Noahmp Table values
  ...
  subroutine NoahmpReadTable(NoahmpIO)
    ...
    integer                                        :: SLCATS
    real(kind=kind_noahmp), dimension(MAX_SOILTYP) :: BB, DRYSMC, MAXSMC, REFSMC, SATPSI, SATDK, SATDW, WLTSMC, CONCL,     &
                                                      CONSA, DBULK, QTZ, BVIC, AXAJ, BXAJ, XXAJ, BDVIC, BBVIC, GDVIC, HC
    namelist / noahmp_stas_soil_categories /          SLTYPE, SLCATS
    namelist / noahmp_soil_stas_parameters /          BB, DRYSMC, MAXSMC, REFSMC, SATPSI, SATDK, SATDW, WLTSMC, CONCL,      &
                                                      CONSA, DBULK, QTZ, BVIC, AXAJ, BXAJ, XXAJ, BDVIC, BBVIC, GDVIC
    namelist / noahmp_soil_stas_ruc_parameters /      BB, DRYSMC, HC, MAXSMC, REFSMC, SATPSI, SATDK, SATDW, WLTSMC, QTZ,    &
                                                      CONCL, CONSA, DBULK, BVIC, AXAJ, BXAJ, XXAJ, BDVIC, BBVIC, GDVIC
    ...
    real(kind=kind_noahmp), dimension(NCROP) :: PLANTPOP, IRRI, GDDTBASE, GDDTCUT, GDDS1, GDDS2, GDDS3, GDDS4, GDDS5, C3PSNI,&
                                                ...
                                                RTCT_S5, RTCT_S6, RTCT_S7, RTCT_S8, BIO2LAI, RGD, RDI, RDMAX, RTOPT, RTB,    &
                                                RTMIN, RORT
    namelist / noahmp_crop_parameters /         DEFAULT_CROP, PLTDAY, HSDAY, PLANTPOP, IRRI, GDDTBASE, GDDTCUT, GDDS1, GDDS2,&
                                                ...
                                                BIO2LAI, RGD, RDI, RDMAX, RTOPT, RTB, RTMIN, RORT
    ...
    if ( .not. allocated (NoahmpIO%CLCON_TABLE)  ) allocate( NoahmpIO%CLCON_TABLE (MAX_SOILTYP) ) !MENG202406
    if ( .not. allocated (NoahmpIO%SACON_TABLE)  ) allocate( NoahmpIO%SACON_TABLE (MAX_SOILTYP) ) !MENG202406
    if ( .not. allocated (NoahmpIO%BULK_TABLE)   ) allocate( NoahmpIO%BULK_TABLE  (MAX_SOILTYP) ) !MENG202406
    ...
    if ( .not. allocated (NoahmpIO%RGD_TABLE)       ) allocate( NoahmpIO%RGD_TABLE      (NCROP) ) ! edited by meng 202405
    if ( .not. allocated (NoahmpIO%RDI_TABLE)       ) allocate( NoahmpIO%RDI_TABLE      (NCROP) ) ! edited by meng 202405
    if ( .not. allocated (NoahmpIO%RDMAX_TABLE)     ) allocate( NoahmpIO%RDMAX_TABLE    (NCROP) ) ! MENG202406
    if ( .not. allocated (NoahmpIO%RTOPT_TABLE)     ) allocate( NoahmpIO%RTOPT_TABLE    (NCROP) ) ! edited by meng 202406
    if ( .not. allocated (NoahmpIO%RTB_TABLE)       ) allocate( NoahmpIO%RTB_TABLE      (NCROP) ) ! edited by meng 202406
    if ( .not. allocated (NoahmpIO%RTMIN_TABLE)     ) allocate( NoahmpIO%RTMIN_TABLE    (NCROP) ) ! edited by meng 202406
    if ( .not. allocated (NoahmpIO%RORT_TABLE)      ) allocate( NoahmpIO%RORT_TABLE     (NCROP) ) ! edited by meng 202406
    ...
    NoahmpIO%CLCON_TABLE        = undefined_real !MENG202406
    NoahmpIO%SACON_TABLE        = undefined_real !MENG202406
    NoahmpIO%BULK_TABLE         = undefined_real !MENG202406
    ...
    NoahmpIO%RGD_TABLE              = undefined_real ! edited by meng 202405
    NoahmpIO%RDI_TABLE              = undefined_real ! edited by meng 202405
    NoahmpIO%RDMAX_TABLE            = undefined_real ! MENG202406
    NoahmpIO%RTOPT_TABLE            = undefined_real ! edited by meng 202406
    NoahmpIO%RTB_TABLE              = undefined_real ! edited by meng 202406
    NoahmpIO%RTMIN_TABLE            = undefined_real ! edited by meng 202406
    NoahmpIO%RORT_TABLE             = undefined_real ! edited by meng 202406
    ...
    NoahmpIO%CLCON_TABLE (1:SLCATS) = CONCL (1:SLCATS)     !MENG202406
    NoahmpIO%SACON_TABLE (1:SLCATS) = CONSA (1:SLCATS)     !MENG202406
    NoahmpIO%BULK_TABLE  (1:SLCATS) = DBULK (1:SLCATS)     !MENG202406
    ...
    NoahmpIO%RGD_TABLE              = RGD   ! edited by meng 202405
    NoahmpIO%RDI_TABLE              = RDI   ! edited by meng 202405
    NoahmpIO%RDMAX_TABLE            = RDMAX ! MENG202406
    NoahmpIO%RTOPT_TABLE            = RTOPT ! edited by meng 202406
    NoahmpIO%RTB_TABLE              = RTB   ! edited by meng 202406
    NoahmpIO%RTMIN_TABLE            = RTMIN ! edited by meng 202406
    NoahmpIO%RORT_TABLE             = RORT  ! edited by meng 202406
