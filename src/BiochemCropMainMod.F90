...
!-------------------------------------------------------------------------
    associate(                                                                       &
              ...
              PerRMass               => noahmp%biochem%state%PerRMass               ,& ! out,   crop root biomass per layer [g/cm2] MENG202406
              ...
              DepthMaxRootDensity    => noahmp%energy%state%DepthMaxRootDensity     ,& ! out,   depth of maximum root density [q/cm2] MENG202406
