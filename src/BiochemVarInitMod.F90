...
!=== initialize with default values
  ...
  subroutine BiochemVarInitDefault(noahmp)
    ...
    if ( .not. allocated(noahmp%biochem%state%PerRMass) )        &
       allocate( noahmp%biochem%state%PerRMass(1:NumSoilLayer) )
   ! MENG202406
    noahmp%biochem%state%PerRMass         (:)       = undefined_real ! MENG202406
    ...
    noahmp%biochem%param%RootGrowDirection          = undefined_real ! edited by meng 202405
    noahmp%biochem%param%RootDistribution           = undefined_real ! edited by meng 202405
    noahmp%biochem%param%MaximumRootDepth           = undefined_real ! MENG202406
    noahmp%biochem%param%OptRootTemperature         = undefined_real ! edited by meng 202406
    noahmp%biochem%param%MinRootTemperature         = undefined_real ! edited by meng 202406
    noahmp%biochem%param%LethalRootTemperature      = undefined_real ! edited by meng 202406
    noahmp%biochem%param%SpecificRootLength         = undefined_real ! edited by meng 202406 
