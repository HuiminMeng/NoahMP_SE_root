...
!---------------------------------------------------------------------
    associate(                                                                       &
              ...
              RootDepth              => noahmp%energy%state%RootDepth               ,& ! inout, RootDepth,edited by meng 202405
              ...
              ThicknessCanBury       => noahmp%energy%state%ThicknessCanBury        ,& ! out,   thickness of canopy buried by snow [m]
