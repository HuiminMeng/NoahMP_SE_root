...
!=== define "state" sub-type of energy (energy%state%variable)
  type :: state_type
    ...
    integer                :: DepthMaxRootDensity         ! Depth of maximum root density [cm]MENG202406
    ...
    real(kind=kind_noahmp) :: RootDepth                   ! root depth [m] Edited by meng 2024
    ...
    !real(kind=kind_noahmp) :: DepthMaxRootDensity         ! Depth of maximum root density [cm]MENG202406

    real(kind=kind_noahmp), allocatable, dimension(:) :: RootLengthDensity     ! Root length density [m/m3] MENG202406
    real(kind=kind_noahmp), allocatable, dimension(:) :: RootFraction          ! root fraction in each soil layer (0 to 1) edited by meng 202405
...
!=== define "parameter" sub-type of energy (energy%param%variable)
  type :: parameter_type
    ...
    real(kind=kind_noahmp), allocatable, dimension(:) :: ClayContent           ! soil clay content [%] MENG202406
    real(kind=kind_noahmp), allocatable, dimension(:) :: SandContent           ! soil sand content [%] MENG202406
    real(kind=kind_noahmp), allocatable, dimension(:) :: SoilBulkDensity       ! Soil layer i bulk density [g/cm3] MENG202406
