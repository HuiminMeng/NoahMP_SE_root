...
! -------------------------------------------------------------------------
    ...
    noahmp%energy%state%RootDepth                                 = NoahmpIO%RDXY    (I,J)                    ! edited by meng 202405
    noahmp%energy%state%DepthMaxRootDensity                       = NoahmpIO%JMXY    (I,J)                    ! MENG202406
    noahmp%energy%state%RootFraction(1:NumSoilLayer)              = NoahmpIO%RFXY    (I,1:NumSoilLayer,J)     ! edited by meng 202405
    noahmp%energy%state%RootLengthDensity(1:NumSoilLayer)         = NoahmpIO%RLDXY   (I,1:NumSoilLayer,J)     ! MENG202406
    ...
    do SoilLayerIndex = 1, size(SoilType)
       ...
       noahmp%energy%param%ClayContent    (SoilLayerIndex)        = NoahmpIO%CLCON_TABLE (SoilType(SoilLayerIndex)) !MENG202406
       noahmp%energy%param%SandContent    (SoilLayerIndex)        = NoahmpIO%SACON_TABLE (SoilType(SoilLayerIndex)) !MENG202406
       noahmp%energy%param%SoilBulkDensity(SoilLayerIndex)        = NoahmpIO%BULK_TABLE  (SoilType(SoilLayerIndex)) !MENG202406 
    enddo
