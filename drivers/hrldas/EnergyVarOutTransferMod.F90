...
!-----------------------------------------------------------------------
    ...
    NoahmpIO%RDXY    (I,J) = noahmp%energy%state%RootDepth                                              ! edited by meng 202405
    NoahmpIO%JMXY    (I,J) = noahmp%energy%state%DepthMaxRootDensity                                    ! MENG202406
    NoahmpIO%RFXY    (I,1:NumSoilLayer,J) = noahmp%energy%state%RootFraction(1:NumSoilLayer)      ! edited by meng 202405
    NoahmpIO%RLDXY   (I,1:NumSoilLayer,J) = noahmp%energy%state%RootLengthDensity(1:NumSoilLayer) ! MENG202406
