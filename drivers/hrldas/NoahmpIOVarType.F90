...
!------------------------------------------------------------------------
    ...
    real(kind=kind_noahmp), allocatable, dimension(:,:)    ::  RDXY                ! root depth [m] edited by meng 202405
    ...
    integer               , allocatable, dimension(:,:)    ::  JMXY                ! depth of maximum root density [g/cm2] MENG202406
    real(kind=kind_noahmp), allocatable, dimension(:,:,:)  ::  RFXY                ! root fraction in each soil layer (0-1) edited by meng 202405
    real(kind=kind_noahmp), allocatable, dimension(:,:,:)  ::  RLDXY               ! root length density [m/m3] MENG202406
    real(kind=kind_noahmp), allocatable, dimension(:,:,:)  ::  PRMASSXY            ! root biomass per layer [g/m2] MENG202406    
...
!----------------------------------------------------------------
    ...
    real(kind=kind_noahmp), allocatable, dimension(:)      :: RGD_TABLE                 ! crop root grow direction parameter edited by meng 202405
    real(kind=kind_noahmp), allocatable, dimension(:)      :: RDI_TABLE                 ! crop root distribution parameter edited by meng 202405
    real(kind=kind_noahmp), allocatable, dimension(:)      :: RDMAX_TABLE               ! Maxium root depth [m] MENG202406
    real(kind=kind_noahmp), allocatable, dimension(:)      :: RTOPT_TABLE               ! crop optimum temperature for root growth, edited by meng 202406
    real(kind=kind_noahmp), allocatable, dimension(:)      :: RTB_TABLE                 ! crop minimum temperature for roots growth, edited by meng 202406
    real(kind=kind_noahmp), allocatable, dimension(:)      :: RTMIN_TABLE               ! crop lethal temperature for root growth, edited by meng 202406
    real(kind=kind_noahmp), allocatable, dimension(:)      :: RORT_TABLE                ! the length of the root system per unit weight, edited by meng 202406
    ...
    real(kind=kind_noahmp), allocatable, dimension(:)      :: CLCON_TABLE               ! soil clay content [%] MENG202406
    real(kind=kind_noahmp), allocatable, dimension(:)      :: SACON_TABLE               ! soil sand content [%] MENG202406
    real(kind=kind_noahmp), allocatable, dimension(:)      :: BULK_TABLE                ! Soil layer i bulk density [g/cm3] MENG202406
